...
```bash
DEPLOY_SERVER=<user-selected-server> bash /Users/cali/.agents/skills/cali-ops-docker-server-dashboard/references/dashboard.sh
```
...
```bash
DEPLOY_SERVER=root@your-server.com ~/.agents/skills/cali-ops-docker-server-dashboard/references/dashboard.sh
```
